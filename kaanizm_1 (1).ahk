...
stroke:="|<stroke>##0$0/0/984866,0/1/8A396D,0/2/86397C,1/2/000094,1/1/08087B,1/0/29296B"
kosma:="|<>##0$0/0/A46D87,0/1/8D444B,0/2/863535,1/0/529CDE,1/1/102942,1/2/000000"
spike1299:="|<>##0$0/0/BC457A,0/1/D34C8A,0/2/E263A1,1/0/8822AA,1/1/BB44DD,1/2/DD88FF"
thrust1299:="|<>##0$0/0/AC3563,0/1/BC457A,0/2/D3548A,1/0/550077,1/1/9933AA,1/2/AA55CC"
a123:="|<>##0$0/0/BA4F83,0/1/AB4474,0/2/9C3966,1/0/7339AD,1/1/5A2194,1/2/310873"
piece1299:="|<>##0$0/0/954545,0/1/8E353D,0/2/8E353D,1/0/221122,1/1/110011,1/2/110022"
blody1299:="|<>##0$0/0/956B8A,0/1/A56B82,0/2/A54C7A,1/0/110077,1/1/330066,1/2/770044"
cut1299:="|<>##0$0/0/C34545,0/1/C33535,0/2/C33535,1/0/771111,1/1/660000,1/2/660000"
shock1299:="|<>##0$0/0/9D3535,0/1/953535,0/2/8E3535,1/0/220000,1/1/110000,1/2/110000"
jab1299:="|<>##0$0/0/AC3535,0/1/AC3535,0/2/AC3535,1/0/550000,1/1/550000,1/2/770000"
stab1299:="|<>##0$0/0/DA7A6B,0/1/C3635C,0/2/9D4535,1/0/BB9977,1/1/665544,1/2/553322"
kor1299:="|<>##0$0/0/863535,0/1/863535,0/2/9D3535,1/0/000000,1/1/000000,1/2/330000"
Pause

Loop
{
  if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, spike1299))
  {
    if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, thrust1299))
    {
      if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, piece1299))
      {
        if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, blody1299))
        {
          if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, cut1299))
          {
            if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, shock123))
            {
              if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, jab123))
              {
                if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, stab))
                {
                  if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, a123))
                  {
                    if (ok:=FindText(X:=0, Y:=0, 109-150000, 487-150000, 109+150000, 487+150000, 0, 0, kor123))
                    {
                      continue
                    }
                    else
